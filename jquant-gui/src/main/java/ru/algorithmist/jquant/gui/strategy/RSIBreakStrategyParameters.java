...
import ru.algorithmist.jquant.signals.RSIBreakSignal; 
 ...
 * @version 1/19/11 
 */ 
public class RSIBreakStrategyParameters implements StrategyParameters{ 
    ...
    public String getName() { 
        return symbol.getValue() + " RSIBreak " + span.getValue(); 
    } 
    ...
    public Strategy configure(CloseSignal closeSignal) { 
        ...
        RSIBreakSignal openSignal = new RSIBreakSignal(security, (Integer)span.getValue(), TimeInterval.DAY, (Double)longThreshold.getValue(), (Double)shortThreshold.getValue()); 
