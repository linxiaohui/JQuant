 ...
 * @version 12/29/10 
 */ 
public class MedianParameter extends CalculatedParameter { 
    ...
    public MedianParameter(Security security, TimeInterval interval) { 
    ...
    public Key createQueryKey() { 
        return Key.from("Median", security.getSymbol(), security.getSource(), interval.getKey()); 
    } 
