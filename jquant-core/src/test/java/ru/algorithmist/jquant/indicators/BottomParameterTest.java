 ...
 * @version 1/17/11 
 */ 
public class BottomParameterTest { 
    ...
    public void testParameter(){ 
        ...
        Value value = DataService.instance().value(dt.toInstant(), new BottomParameter(new Security("IBM", "TEST"), TimeInterval.DAY)); 
        assertThat(value.isOK(), is(equalTo(TRUE))); 
        assertThat(value.getValue(), is(equalTo(145.31))); 
    } 
}