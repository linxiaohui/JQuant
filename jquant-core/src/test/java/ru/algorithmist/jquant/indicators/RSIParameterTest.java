...
public class RSIParameterTest { 
    ...
    public void testParameter(){ 
        ...
        Value value = DataService.instance().value(dt.toInstant(), new RSIParameter(new Security("IBM", "TEST"), 7, TimeInterval.DAY)); 
        assertThat(value.isOK(), is(equalTo(TRUE))); 
        assertThat(value.getValue(), is(closeTo(58.7065780704, 1e-6))); 
    } 
