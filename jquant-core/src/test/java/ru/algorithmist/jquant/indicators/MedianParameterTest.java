 ...
 * @version 1/17/11 
 */ 
public class MedianParameterTest { 
    ...
    public void testParameter(){ 
        ...
        Value value = DataService.instance().value(dt2.toInstant(), new MedianParameter(new Security("IBM", "TEST"), TimeInterval.DAY)); 
        assertThat(value.isOK(), is(equalTo(TRUE))); 
        assertThat(value.getValue(), is(equalTo(145.51))); 
    } 
}