...
public class ADXParameterTest { 
    ...
    public void testParameter(){ 
        ...
        Value value = DataService.instance().value(dt.toInstant(), new ADXParameter(new Security("IBM", "TEST"), TimeInterval.DAY, 14)); 
        assertThat(value.isOK(), is(equalTo(TRUE))); 
        assertThat(value.getValue(), closeTo(24.6267496177, 1e-6)); 
    } 
