...
public class TopParameterTest { 
    ...
    public void testParameter(){ 
        ...
        Value value = DataService.instance().value(dt.toInstant(), new TopParameter(new Security("IBM", "TEST"), TimeInterval.DAY)); 
        assertThat(value.isOK(), is(equalTo(TRUE))); 
        assertThat(value.getValue(), is(equalTo(145.71))); 
    } 
}